...
def play_hb(d):
    for i in range(len(melody)):
      noteDuration = int((1000 // tempo[i]) // speed)

      freq = NOTES_MAP[melody[i]]
      
      d.controller_buzzer(freq, noteDuration)
